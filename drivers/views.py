...
def send_text(profile, driver):
	...
	msg = "Hey, " + str(profile.user.first_name) + "! Your Over Easy driver " + str(driver.user.first_name) + " is outside with your breakfast. You can reach your driver at " + str(driver.phone) + "."	
